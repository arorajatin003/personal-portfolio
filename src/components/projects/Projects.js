...
function Projects() {
    const projects = [
        ...
        {key:2, title: "WhatsApp Clone", discription:"It is realtime group chat app where anyone can create a public room and chat. It has a google authentication.",img:"../images/wp.PNG",github:"https://github.com/arorajatin003/WhatsApp-clone",project:"https://whatsapp-clone-e93bb.web.app/" },
        {key:3, title: "Chrome Extention", discription:"It is a chrome extention which uses api to featch on demand joke whenever user clicks on extention icon.",img:"../images/ex.PNG",github:"",project:""},
        {key:4, title: "Tesla Clone", discription:"It is a tesla clone website which uses styled Components for designing.",img:"../images/tesla.PNG",github:"https://github.com/arorajatin003/tesla-landing-page",project:"https://tesla-clone-aa597.web.app/#"},
